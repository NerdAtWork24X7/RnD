...
;fish_tank.c,25 :: 		while(1)
L_main1:
;fish_tank.c,28 :: 		if(!MENU)
	BTFSC      PORTA+0, 0
	GOTO       L_main3
;fish_tank.c,30 :: 		menu_fnc();
	CALL       _menu_fnc+0
;fish_tank.c,31 :: 		write_I2C(0xA0,0x0210,pattern);    //Writing the pattern to EEPROM
	MOVLW      160
	...
	CALL       _write_I2C+0
;fish_tank.c,32 :: 		Check_time();
	CALL       _Check_time+0
;fish_tank.c,33 :: 		init_lcd();
	CALL       _init_lcd+0
;fish_tank.c,34 :: 		Display_Time();
	CALL       _Display_Time+0
;fish_tank.c,35 :: 		set_Intensity();
	CALL       _Set_Intensity+0
;fish_tank.c,36 :: 		}
L_main3:
;fish_tank.c,37 :: 		Check_time();
	CALL       _Check_time+0

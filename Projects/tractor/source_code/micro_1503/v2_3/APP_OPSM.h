...
#define COND14 ((SEAT_SWITCH)&(!PTO)&(HAND_BRAKE)&(ENGINE_SENSE))
#define COND15 ((SEAT_SWITCH)&(!PTO)&(!HAND_BRAKE)&(!ENGINE_SENSE))
#define COND16 ((SEAT_SWITCH)&(!PTO)&(!HAND_BRAKE)&(ENGINE_SENSE))



#define DEBO_TIME 20000

#define TOTAL_COND 17

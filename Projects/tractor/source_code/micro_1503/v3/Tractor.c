...
void check_cond()
{
    uint8 cnt = 0;
    guc_choice = 0;
    if(COND1) { guc_choice=1; deb_delay();}
    if(COND2)
    {
       for(i=0;i<100;i++)
        {
    ...
    if(COND6)
    {
       for(i=0;i<100;i++)
        ...
        if(cnt > 60) guc_choice = 6;
    }
    if(COND3) { guc_choice=3;   deb_delay();}
    if(COND4) { guc_choice=4;   deb_delay();}
    if(COND5) { guc_choice=5;   deb_delay();}
    if(COND7) { guc_choice=7;   deb_delay();}
    if(COND8) { guc_choice=8;   deb_delay();}
    if(COND9) { guc_choice=9;   deb_delay();}
    if(COND10) { guc_choice=10; deb_delay();}
    if(COND11) { guc_choice=11; deb_delay();}
    if(COND12) { guc_choice=12; deb_delay();}
    if(COND13) { guc_choice=13; deb_delay();}
 /* if(COND1)
   {

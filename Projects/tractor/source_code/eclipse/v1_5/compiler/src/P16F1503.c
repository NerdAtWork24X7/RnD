...
sfr unsigned int   volatile FSR0             absolute 0x0004;
...
sfr unsigned int   volatile FSR1             absolute 0x0006;
...
sfr unsigned short volatile TOSH             absolute 0x0FEF;
    ...
    const register unsigned short int SSSEL = 4;
    sbit  SSSEL_bit at APFCON.B4;
